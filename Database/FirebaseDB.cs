...
namespace Internet_Cafe_Manager_App.Database
{
    public class FirebaseDB
    {
        ...
        // Dán những phương thức mới này vào cuối lớp FirebaseDB.cs
        ...
        /// </summary>
        /// <returns>Trả về tên PC (ví dụ: "PC1"), hoặc null nếu không tìm thấy.</returns>
        ...
        /// </summary>
        /// <returns>Danh sách các đối tượng PC đang online.</returns>
